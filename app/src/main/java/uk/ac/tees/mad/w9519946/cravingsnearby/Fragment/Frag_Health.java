...
public class Frag_Health extends Fragment {
    ...
    private String science_category = "health";
    private RecyclerView health_Recycler_View;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vitamin =  inflater.inflate(R.layout.frag_health, container, false);
        health_Recycler_View = vitamin.findViewById(R.id.recycler_Relative_View);
        news_dataArrayList = new ArrayList<>();
        health_Recycler_View.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter_news = new Adapter_News(getContext(), news_dataArrayList);
        health_Recycler_View.setAdapter(adapter_news);
