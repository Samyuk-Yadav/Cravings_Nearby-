...
public class Frag_Sciences extends Fragment {
    ...
    private String science_category = "science";
    private RecyclerView science_Recycler_View;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vitamin =  inflater.inflate(R.layout.frag_sciences, container, false);
        science_Recycler_View = vitamin.findViewById(R.id.recycler_Sciences_View);
        news_dataArrayList = new ArrayList<>();
        science_Recycler_View.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter_news = new Adapter_News(getContext(), news_dataArrayList);
        science_Recycler_View.setAdapter(adapter_news);
    ...
    private void news_Search_Find() {
        News_API_Utis.getNews_API_Interface().getCatrgoricalNews(counting_Country, science_category, 90, sAPI_KEY_API).enqueue(new Callback<Top_News_data>() {
            @Override
