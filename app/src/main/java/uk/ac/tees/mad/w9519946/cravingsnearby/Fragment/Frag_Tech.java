...
public class Frag_Tech extends Fragment {
    ...
    private String science_category = "technology";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tech_Recycler_View = vitamin.findViewById(R.id.recycler_Technology_View);
        ...
        tech_Recycler_View.setAdapter(adapter_news);
