...
public class Frag_Entertain extends Fragment {
    ...
    private String science_category = "entertainment";
    private RecyclerView entertainment_Recycler_View;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vitamin =  inflater.inflate(R.layout.frag_tech, container, false);
        entertainment_Recycler_View = vitamin.findViewById(R.id.recycler_Technology_View);
        news_dataArrayList = new ArrayList<>();
        entertainment_Recycler_View.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter_news = new Adapter_News(getContext(), news_dataArrayList);
        entertainment_Recycler_View.setAdapter(adapter_news);
